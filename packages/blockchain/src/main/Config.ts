...
const Config = {
    ...
    solana: {
        cluster: Env.get('SOLANA_CLUSTER'),
        ammoMintPrivateKey: Env.get('AMMO_MINT_PRIVATE_KEY'),
        ammoTokenAddress: Env.get('AMMO_TOKEN_ADDRESS'),
        sendAmmoThrottleTime: Env.getAsInt('SEND_AMMO_THROTTLE_TIME'),
    },
}
